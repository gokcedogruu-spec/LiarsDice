...
const ITEMS_META = {
    ...
    'skin_gold':  { name: 'Золото', price: 2500, type: 'skins' },
    'skin_black': { name: 'Черная метка', price: 10000, type: 'skins' },
    'skin_blue':  { name: 'Морской', price: 6300, type: 'skins' },
    'skin_green': { name: 'Яд', price: 12000, type: 'skins' },
    'skin_purple':{ name: 'Магия вуду', price: 15000, type: 'skins' },
    'skin_cyber': { name: 'Кибер', price: 20000, type: 'skins' },
    'skin_bone':  { name: 'Костяной', price: 30000, type: 'skins' },
